...
> SetValidator only exports a value and always succeeds Parameters: 'value' value that should be exported
...
| Since | `1.0.0` |
| Source | `Validator/SetValidator.php` |

## Methods

| Method | Description |
|---|---|
| [`getAcceptedParameters(): array<int, string>`](#getacceptedparameters) | Returns the base Validator parameters plus 'value'. |
...
'value' is the value this validator exports; it is passed through untouched and the validator always succeeds, so there is nothing else to configure.
