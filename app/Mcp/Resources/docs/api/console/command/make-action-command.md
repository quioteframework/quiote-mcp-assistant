...
> Scaffolds an Action (and, unless --no-view, a matching View + Template) inside an existing app's Modules/{module}/ tree -- the \"inside an app\" counterpart to `new` scaffolding a whole app from nothing.
...
| Since | `1.0.0` |
| Source | `Console/Command/MakeActionCommand.php` |
