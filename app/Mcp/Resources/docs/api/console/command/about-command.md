...
> Prints framework/app diagnostic info.

Prints framework/app diagnostic info.

Deliberately trivial: it exists to prove the bootstrap-in-console-context path (app-dir resolution + Quiote::bootstrap()) works before building real commands (routes:list, routes:compile) on top of it.
...
| Since | `1.0.0` |
| Source | `Console/Command/AboutCommand.php` |
