# QueueFailedListCommand

> Lists jobs that exhausted their retries (see InspectableFailedJobStoreInterface).

Lists jobs that exhausted their retries (see [`InspectableFailedJobStoreInterface`](/api/queue/inspectable-failed-job-store-interface/)).
...
|  |  |
|---|---|
| Extends | [`AbstractQueueFailedCommand`](/api/queue/console/abstract-queue-failed-command/) |
| Source | `Console/QueueFailedListCommand.php` |
