...
> ContainerTestCase is the base class for all tests that target a specific container execution and provides the necessary assertions
...
| Since | `1.0.0` |
| Source | `Testing/ContainerTestCase.php` |

## Properties

| Property | Type | Description |
|---|---|---|
| `$acionName` | `mixed` | _protected._ |
| `$moduleName` | `mixed` | _protected._ |
| `$response` | `mixed` | _protected._ |

## Methods

| Method | Description |
|---|---|
| [`execute(array<string, mixed>|null $arguments = null, string|null $outputType = null, string|null $requestMethod = null): void`](#execute) | dispatch the request |

### execute()

`public function execute(array<string, mixed>|null $arguments = null, string|null $outputType = null, string|null $requestMethod = null): void`
