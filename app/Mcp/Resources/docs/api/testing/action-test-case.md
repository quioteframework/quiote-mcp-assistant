...
> ActionTestCase is the base class for all action testcases and provides the necessary assertions
...
| Since | `1.0.0` |
| Source | `Testing/ActionTestCase.php` |

## Properties

| Property | Type | Description |
|---|---|---|
| `$validationManager` | `mixed` | _protected._ |
| `$viewModuleName` | `mixed` | _protected._ |
...
| Method | Description |
|---|---|
| [`assertDefaultView(mixed $expected, string $message = 'Failed asserting that the defaultView is the expected value.'): void`](#assertdefaultview) | asserts that the DefaultView is the expected |
| [`assertFailedArgument(string $argumentName, string $source = 'parameters', string $message = 'Failed asserting that the argument <%1$s> is failed.'): void`](#assertfailedargument) | asserts that the given argument has failed the validation |
| [`assertHandlesMethod(string $method, boolean $acceptGeneric = true, string $message = ''): void`](#asserthandlesmethod) | assert that the action handles the given request method |
| [`assertIsNotSimple(string $message = 'Failed asserting that the action is not simple.'): void`](#assertisnotsimple) | assert that the action is not simple |
| [`assertIsSimple(string $message = 'Failed asserting that the action is simple.'): void`](#assertissimple) | assert that the action is simple |
| [`assertNotHandlesMethod(string $method, boolean $acceptGeneric = true, string $message = ''): void`](#assertnothandlesmethod) | assert that the action does not handle the given request method |
| [`assertSucceededArgument(string $argumentName, string $source = 'parameters', string $message = 'Failed asserting that the argument <%1$s> is succeeded.'): void`](#assertsucceededargument) | asserts that the given argument has succeeded the validation |
| [`assertValidatedArgument(string $argumentName, string $source = 'parameters', string $message = 'Failed asserting that the argument <%1$s> is validated.'): void`](#assertvalidatedargument) | asserts that the given argument has been touched by a validator This does not imply that the validation failed or succeeded, just that a validator attempted to validate the given argument |
| [`assertViewModuleNameEquals(string $expected, string $message = 'Failed asserting that the view\'s module name is <%1$s>.'): void`](#assertviewmodulenameequals) | asserts that the view's modulename is the expected value after runAction was called |
| [`assertViewNameEquals(string $expected, string $message = 'Failed asserting that the view\'s name is <%1$s>.'): void`](#assertviewnameequals) | asserts that the viewName is the expected value after runAction was called |
| [`performValidation(): void`](#performvalidation) | register the validators for this testcase |
| [`runAction(): void`](#runaction) | run the action for this testcase |

### assertDefaultView()

`protected function assertDefaultView(mixed $expected, string $message = 'Failed asserting that the defaultView is the expected value.'): void`
...
|---|---|---|
| `$expected` | `mixed` | A string containing the view name associated with the action. Or an array with the following indices: - The parent module of the view that will be executed. - The view that will be executed. |
| `$message` | `string` | an optional message to display if the test fails |

### assertFailedArgument()

`protected function assertFailedArgument(string $argumentName, string $source = 'parameters', string $message = 'Failed asserting that the argument <%1$s> is failed.'): void`
...
| `$source` | `string` | the source of the argument |
| `$message` | `string` | an optional message |

### assertHandlesMethod()

`protected function assertHandlesMethod(string $method, boolean $acceptGeneric = true, string $message = ''): void`
...
`protected function assertIsNotSimple(string $message = 'Failed asserting that the action is not simple.'): void`
...
`protected function assertIsSimple(string $message = 'Failed asserting that the action is simple.'): void`
...
### assertNotHandlesMethod()

`protected function assertNotHandlesMethod(string $method, boolean $acceptGeneric = true, string $message = ''): void`
...
### assertSucceededArgument()

`protected function assertSucceededArgument(string $argumentName, string $source = 'parameters', string $message = 'Failed asserting that the argument <%1$s> is succeeded.'): void`
...
### assertValidatedArgument()

`protected function assertValidatedArgument(string $argumentName, string $source = 'parameters', string $message = 'Failed asserting that the argument <%1$s> is validated.'): void`
...
### assertViewModuleNameEquals()

`protected function assertViewModuleNameEquals(string $expected, string $message = 'Failed asserting that the view\'s module name is <%1$s>.'): void`
...
| Parameter | Type | Description |
|---|---|---|
| `$expected` | `string` | the expected moduleName |
| `$message` | `string` | an optional message to display if the test fails |

### assertViewNameEquals()

`protected function assertViewNameEquals(string $expected, string $message = 'Failed asserting that the view\'s name is <%1$s>.'): void`
...
| Parameter | Type | Description |
|---|---|---|
| `$expected` | `string` | the expected viewname in short form ('Success' etc) |
| `$message` | `string` | an optional message to display if the test fails |
