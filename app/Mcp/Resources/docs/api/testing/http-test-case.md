...
> Base class for fluent, full-pipeline HTTP tests: builds a real PSR-7 request and dispatches it through Context::handle() (the same entry point production traffic uses), returning an assertable TestResponse.

Base class for fluent, full-pipeline HTTP tests: builds a real PSR-7 request and dispatches it through [`Context::handle()`](/api/context/#handle) (the same entry point production traffic uses), returning an assertable [`TestResponse`](/api/testing/http/test-response/).
...
| Source | `Testing/HttpTestCase.php` |

## Properties

| Property | Type | Description |
|---|---|---|
| `$contextName` | `?``string` | _protected._ |

## Methods

| Method | Description |
|---|---|
| [`delete(string $uri, array<string, mixed> $data = [], array<string, string> $headers = []): TestResponse`](#delete) |  |
| [`get(string $uri, array<string, string> $headers = []): TestResponse`](#get) |  |
| [`getContext(): Context`](#getcontext) |  |
| [`json(string $method, string $uri, array<string, mixed> $data = [], array<string, string> $headers = []): TestResponse`](#json) |  |
| [`patch(string $uri, array<string, mixed> $data = [], array<string, string> $headers = []): TestResponse`](#patch) |  |
| [`post(string $uri, array<string, mixed> $data = [], array<string, string> $headers = []): TestResponse`](#post) |  |
| [`put(string $uri, array<string, mixed> $data = [], array<string, string> $headers = []): TestResponse`](#put) |  |
| [`setUp(): void`](#setup) | Set up the test environment. |
| [`tearDown(): void`](#teardown) | Clean up after the test has run |

### delete()

`public function delete(string $uri, array<string, mixed> $data = [], array<string, string> $headers = []): TestResponse`
...
`public function get(string $uri, array<string, string> $headers = []): TestResponse`
...
`public function json(string $method, string $uri, array<string, mixed> $data = [], array<string, string> $headers = []): TestResponse`
...
`public function patch(string $uri, array<string, mixed> $data = [], array<string, string> $headers = []): TestResponse`
...
`public function post(string $uri, array<string, mixed> $data = [], array<string, string> $headers = []): TestResponse`
...
`public function put(string $uri, array<string, mixed> $data = [], array<string, string> $headers = []): TestResponse`
