...
> The Quiote Assistant MCP — an MCP server that gives AI coding agents authoritative knowledge of the framework, plus reflection, project introspection, and scaffolding tools.
